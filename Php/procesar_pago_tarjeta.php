...
//Verificar que el usuario esté en el flujo correcto y los datos lleguen por POST
...
//Realizar las validaciones de la tarjeta (simulación)
$error = null;
...
//Si hay un error, regresar a la página de pago
if ($error) {
...
//SI LA VALIDACIÓN ES EXITOSA, SIMULAMOS EL PAGO Y GUARDAMOS LA ORDEN
try {
