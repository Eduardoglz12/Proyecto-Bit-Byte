...
<body>
    <div class="cont-principal">
            ...
            <tbody>
                <tr>
                    <form action="../php/insertar.php" method="post">
                        ...
                        <td data-label="URL Imagen">
                            <input type="text" name="prod_imagen_url" placeholder="ej: img/art1.webp" required>
                        </td>
                        <td data-label="URL Specs">
                            <input type="text" name="prod_spec_url" placeholder="ej: img/specs/art1_specs.webp" required>
                        </td>
                        <td data-label="Cantidad">
                            <input type="number" name="prod_stock" required>
                        </td>
                        <td data-label="Precio">
                            <input type="text" name="prod_price" placeholder="ej: 2199.00" required>
                        </td>
        ...
        <table>
            ...
            <tbody>
                <!-- Fila para seleccionar producto -->
                <tr>
                    <form action="inventario.php" method="get">
                        <td data-label="Seleccionar" colspan="5">
                ...
                <!-- Fila con datos del producto a editar -->
                <?php if ($producto_a_editar): ?>
                    <tr>
                        <form action="../php/actualizar.php" method="post">
                            ...
                            <td data-label="Producto">
                                <input type="text" name="prod_name" value="<?php echo htmlspecialchars($producto_a_editar['prod_name']); ?>" required>
                            </td>
                            <td data-label="URL Imagen">
                                <input type="text" name="prod_imagen_url" value="<?php echo htmlspecialchars($producto_a_editar['prod_imagen_url']); ?>" required>
                            </td>
                            <td data-label="URL Specs">
                                <input type="text" name="prod_spec_url" value="<?php echo htmlspecialchars($producto_a_editar['prod_spec_url']); ?>" required>
                            </td>
                            <td data-label="Cantidad">
                                <input type="number" name="prod_stock" value="<?php echo htmlspecialchars($producto_a_editar['prod_stock']); ?>" required>
                            </td>
                            <td data-label="Precio">
                                <input type="text" name="prod_price" value="<?php echo htmlspecialchars($producto_a_editar['prod_price']); ?>" required>
                            </td>
                            <td data-label="Acción">
                ...
                <?php if ($resultado_tabla->num_rows > 0): ?>
                    <?php while($fila = $resultado_tabla->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td data-label="URL Imagen">
                                <?php echo htmlspecialchars($fila['prod_imagen_url']); ?>
                            </td>
                            <td data-label="URL Specs">
                                <?php echo htmlspecialchars($fila['prod_spec_url']); ?>
                            </td>
                            <td data-label="Cantidad">
                                <?php echo htmlspecialchars($fila['prod_stock']); ?>
                            </td>
                            <td data-label="Precio">
                                $<?php echo number_format($fila['prod_price'], 2); ?>
                            </td>
                            <td data-label="Acción">
